...
public class SeashoreLongShortDialogFragment extends DialogFragment {

    private String[] mAnswers = {"Longer", "Shorter"};
    private static Object sCheckedItem;

    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        builder.setTitle("Was the second sound longer or shorter than the first one?")
